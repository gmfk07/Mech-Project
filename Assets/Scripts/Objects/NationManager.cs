...
public class NationManager : MonoBehaviour
{
    ...
    public void Start() {
        ...
        {
            nations.Add(new Nation(i, landBorderMaterials[i], waterBorderMaterials[i]));
        }
...
public class Nation
{
    ...
    public Nation(int player, Material landBorderMaterial, Material waterBorderMaterial)
    {
        this.player = player;
